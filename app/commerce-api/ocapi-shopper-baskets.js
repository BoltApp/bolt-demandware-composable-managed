...
class OcapiShopperBaskets {
    ...
    async getSessionId(...args) {
        const {basketId} = args[0].parameters
        return this.fetch(`custom_objects/CustomApi/get-customer?client_id=c6218dbd-10eb-4841-969a-748399b4c3f6&customer_no=${basketId}`, 'GET', args, 'getSessionId')
    }
}
